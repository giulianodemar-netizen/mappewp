 ...
 * 
 * This does not comply with our namespaces or architecture
 * 
 * We should do away with this in avor of the new import/export tools
*/
...
class WPGMapsImportExport{
	...
	/**
	 * @deprecated since 9.0.0, replaced by export CSV map method
	*/ 
	...
	/**
	 * @deprecated since 9.0.0, replaced by export CSV polygon method
	*/
	...
	/**
	 * @deprecated since 9.0.0, replaced by export CSV polyline method
	*/
