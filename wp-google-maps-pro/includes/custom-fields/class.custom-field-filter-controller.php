...
class CustomFieldFilterController
{
	...
	protected function getFilterQueries()
	{
		...
		foreach($params['widgetData'] as $widgetData)
		{
			...
			/* Developer Hook (Filter) - Modify custom field filter for a specific map/field */
	...
	protected function getQuery()
	{
		...
		/* Developer Hook (Filter) - Modify custom field filter query */
	...
	public function getFilteredMarkerIDs()
	{
		...
		/* Developer Hook (Filter) - Modify custom field filter marker ID's */
...
function custom_field_filter_get_filtered_marker_ids() {
	...
	/* Developer Hook (Filter) - Alter controller with respect to filtering over ajax */
